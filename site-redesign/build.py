...
Artifact tool adds itself. Usage:
  ...
  python3 build.py OUT_DIR [--home URL] [--prices URL] [--pdf URL]
"""
...
home_url = opts.get('--home', 'index.html'); prices_url = opts.get('--prices', 'price-list.html'); pdf_url = opts.get('--pdf', 'AXIOM-Price-List.pdf')
