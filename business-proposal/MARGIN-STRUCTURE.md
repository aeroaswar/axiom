...
|---|---:|---:|
| Supplier cost (vials) | 84.670.000 | 33.6% |
| Pen (81 × Rp 600.000) | 48.600.000 | 19.3% |
| **= Base price** | **133.270.000** | **52.8%** |
| **Margin** | **118.930.000** | **47.2%** |
| **= Selling price** | **252.200.000** | 100.0% |

Markup on base price: 89.2%.

## By pathway

| Pathway | Lots | Supplier cost | Base price | Selling price | Margin | % |
|---|---:|---:|---:|---:|---:|---:|
| 01 GLP-1s & Weight Loss | 12 | 19.000.000 | 26.200.000 | 47.300.000 | 21.100.000 | 44.6% |
...
| **All** | **81** | **84.670.000** | **133.270.000** | **252.200.000** | **118.930.000** | **47.2%** |

## What this still does not measure

Net margin. Operating cost — premises, staff, marketing, payment fees, wastage, tax
— appears in neither the price list nor the supplier sheet. **118.930.000 of gross
margin on 252.200.000 of revenue** is the envelope all of it has to come out of.
