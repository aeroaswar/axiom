...
the app, and its catalogue is a second copy of prices that `supabase/seed.sql` owns. Treat the
database as authoritative; retire this file once the Console covers the offline case.
