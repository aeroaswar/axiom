...
- `dosage-guide/` — the AXIOM protocol card and the compound guide it scans through
  to. A print-ready 85 × 55 mm card with a locally generated QR, and a mobile-first
  guide covering administration cadence, documented protocol, reconstitution and
  studied benefits — with the evidence tier stated for every dosing figure.
