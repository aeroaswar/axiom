...
site-redesign/         static marketing site (home + price list, EN/ID, shared assets/, build.py for single-file copies), priced from the 79-lot V1.0 price list PDF beside it
```
